...
namespace EmployeeUI.Controllers
{
    public class EmployeeController : BaseController
    {
        ...
        public EmployeeController(EmployeeModel context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpId,EManagerId,Email,EmpName,Address,WageRate,Contact,Department,JoinDate,Designation")] Employee employee)
        {
